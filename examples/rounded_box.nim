...
proc roundedBoxShader(fragColor: var Vec4, uv: Vec2, pos: Attribute[Vec4], neg: Attribute[Vec4], time: Uniform[float32]) =
  ...
  dropShadow(d, stdDevFactor=1.0/1.2, spread=10.0, factor=10.0, fragColor)
